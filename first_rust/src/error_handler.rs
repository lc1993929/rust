...
impl CustomError {
    pub fn new(error_status_code: u16, error_msg: String) -> CustomError {
        CustomError {
            error_status_code,
...
impl From<DieselError> for CustomError {
    fn from(error: DieselError) -> Self {
        match error {
            ...
            DieselError::NotFound => CustomError::new(404, "雇员记录没有找到".to_string()),
            err => CustomError::new(500, format!("未知的DieselError{}", err)),
        }
    }
}
